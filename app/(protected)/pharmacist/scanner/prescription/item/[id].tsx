...
//         </TouchableOpacity>
//         <View style={{ flex: 1 }}/>
//         <Text style={[styles.headerText, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>Prescription</Text>
//       </View>
...
//           <Text style={[styles.doctorSpeciality, { color: isDarkMode ? Colors.dark.textSecondary : '#6B7280' }]}>{record.user.age} years</Text>
//           <View style={styles.locationContainer}>
//             <MaterialCommunityIcons name="calendar" size={hp('2%')} color={isDarkMode ? Colors.dark.textSecondary : '#6B7280'} />
//             {/* <Icon name="location-outline" size={hp('2%')} color={isDarkMode ? Colors.dark.textSecondary : '#6B7280'} /> */}
...
//           <Text style={[styles.sectionTitle, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>Item Name</Text>
//           <Text style={[styles.sectionTitle, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>Dosage</Text>
//           <Text style={[styles.sectionTitle, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>Duration</Text>
//         </View>

//         {/* {reportPrescriptions.map((drug) => (
//           <View style={styles.row} key={drug.id}>
//             <Text style={[styles.priceText, { color: isDarkMode ? Colors.dark.textSecondary : '#6B7280' }]}>{drug.name}</Text>
//             <Text style={[styles.priceAmount, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>{drug.dosage}</Text>
//             <Text style={[styles.priceAmount, { color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>{drug.quantity}</Text>
//           </View>
//         ))} */}
// 		{reportPrescriptions.map((drug) => (
//           <View style={styles.row} key={drug.$id}>
//             <Text style={[{ color: isDarkMode ? Colors.dark.textSecondary : '#6B7280' }]}>
...
//             </Text>
//             <Text style={[{ color: isDarkMode ? Colors.dark.text : Colors.light.text }]}>
//               {/* You need to access the quantity from the drug object */}
//               {drug.duration}
//             </Text>
//           </View>
//         ))}
