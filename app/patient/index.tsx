...
const Home = () => {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.profileContainer}>
          ...
          <Image
            source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp_FZBNQO2Mj7jdd7QAkq71nwczukcyEauww&s' }} 
  ...
  >
    <Text style={styles.cardTitle}>Upcoming Scheduling Appointments</Text>
        ...
        <View style={styles.otherCardsContainer}>
          <TouchableOpacity style={[styles.card, styles.smallCard]} onPress={handlePressTrack}>
          <ImageBackground 
  ...
  >
          ...
          <TouchableOpacity style={[styles.card, styles.smallCard]} onPress={handlePress}>
          <ImageBackground 
